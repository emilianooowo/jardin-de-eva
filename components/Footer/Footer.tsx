...
const floresNav = [
    { label: 'MARGARITA', href: '/flores/MARGARITA' },
    { label: 'PARVIFOLIA', href: '/flores/PARVIFOLIA' },
    ...
    { label: 'DOLAR MONEDA', href: '/flores/DOLAR MONEDA' },
    { label: 'EUCALIPTO', href: '/flores/EUCALIPTO' },
    { label: 'LIRIO', href: '/flores/LIRIO' },
    { label: 'MINI GERBERA', href: '/flores/MINI GERBERA' },
    { label: 'NUBE', href: '/flores/NUBE' },
    { label: 'PERRITO', href: '/flores/PERRITO' },
]
